...
class itti_sxab_msg : public itti_msg {
 public:
  itti_sxab_msg(const itti_msg_type_t msg_type, const task_id_t origin,
  ...
  itti_sxab_msg(const itti_sxab_msg& i, const task_id_t orig,
...
class itti_sxab_heartbeat_request : public itti_sxab_msg {
 public:
  itti_sxab_heartbeat_request(const task_id_t origin,
                              const task_id_t destination)
...
class itti_sxab_heartbeat_response : public itti_sxab_msg {
 public:
  itti_sxab_heartbeat_response(const task_id_t origin,
                               const task_id_t destination)
...
class itti_sxab_pfcp_pfd_management_request : public itti_sxab_msg {
 public:
  itti_sxab_pfcp_pfd_management_request(const task_id_t origin,
                                        const task_id_t destination)
...
class itti_sxab_pfcp_pfd_management_response : public itti_sxab_msg {
 public:
  itti_sxab_pfcp_pfd_management_response(const task_id_t origin,
                                         const task_id_t destination)
...
class itti_sxab_association_setup_request : public itti_sxab_msg {
 public:
  itti_sxab_association_setup_request(const task_id_t origin,
                                      const task_id_t destination)
...
class itti_sxab_association_setup_response : public itti_sxab_msg {
 public:
  itti_sxab_association_setup_response(const task_id_t origin,
                                       const task_id_t destination)
...
class itti_sxab_association_update_request : public itti_sxab_msg {
 public:
  itti_sxab_association_update_request(const task_id_t origin,
                                       const task_id_t destination)
...
class itti_sxab_association_update_response : public itti_sxab_msg {
 public:
  itti_sxab_association_update_response(const task_id_t origin,
                                        const task_id_t destination)
...
class itti_sxab_association_release_request : public itti_sxab_msg {
 public:
  itti_sxab_association_release_request(const task_id_t origin,
                                        const task_id_t destination)
...
class itti_sxab_association_release_response : public itti_sxab_msg {
 public:
  itti_sxab_association_release_response(const task_id_t origin,
                                         const task_id_t destination)
...
class itti_sxab_version_not_supported_response : public itti_sxab_msg {
 public:
  itti_sxab_version_not_supported_response(const task_id_t origin,
                                           const task_id_t destination)
      : itti_sxab_msg(SXAB_VERSION_NOT_SUPPORTED_RESPONSE, origin,
                      destination) {}
...
class itti_sxab_node_report_request : public itti_sxab_msg {
 public:
  itti_sxab_node_report_request(const task_id_t origin,
                                const task_id_t destination)
...
class itti_sxab_node_report_response : public itti_sxab_msg {
 public:
  itti_sxab_node_report_response(const task_id_t origin,
                                 const task_id_t destination)
...
class itti_sxab_session_set_deletion_request : public itti_sxab_msg {
 public:
  itti_sxab_session_set_deletion_request(const task_id_t origin,
                                         const task_id_t destination)
...
class itti_sxab_session_set_deletion_response : public itti_sxab_msg {
 public:
  itti_sxab_session_set_deletion_response(const task_id_t origin,
                                          const task_id_t destination)
...
class itti_sxab_session_establishment_request : public itti_sxab_msg {
 public:
  itti_sxab_session_establishment_request(const task_id_t origin,
                                          const task_id_t destination)
...
class itti_sxab_session_establishment_response : public itti_sxab_msg {
 public:
  itti_sxab_session_establishment_response(const task_id_t origin,
                                           const task_id_t destination)
      : itti_sxab_msg(SXAB_SESSION_ESTABLISHMENT_RESPONSE, origin,
                      destination) {}
...
class itti_sxab_session_modification_request : public itti_sxab_msg {
 public:
  itti_sxab_session_modification_request(const task_id_t origin,
                                         const task_id_t destination)
...
class itti_sxab_session_modification_response : public itti_sxab_msg {
 public:
  itti_sxab_session_modification_response(const task_id_t origin,
                                          const task_id_t destination)
...
class itti_sxab_session_deletion_request : public itti_sxab_msg {
 public:
  itti_sxab_session_deletion_request(const task_id_t origin,
                                     const task_id_t destination)
...
class itti_sxab_session_deletion_response : public itti_sxab_msg {
 public:
  itti_sxab_session_deletion_response(const task_id_t origin,
                                      const task_id_t destination)
...
class itti_sxab_session_report_request : public itti_sxab_msg {
 public:
  itti_sxab_session_report_request(const task_id_t origin,
                                   const task_id_t destination)
...
class itti_sxab_session_report_response : public itti_sxab_msg {
 public:
  itti_sxab_session_report_response(const task_id_t origin,
                                    const task_id_t destination)
