...
public:
  ...
  void handle_itti_msg (std::shared_ptr<core::itti::itti_s5s8_delete_session_request> m);
  void handle_itti_msg (std::shared_ptr<core::itti::itti_s5s8_modify_bearer_request> m);
  void handle_itti_msg (std::shared_ptr<core::itti::itti_s5s8_release_access_bearers_request> m);
  void handle_itti_msg (core::itti::itti_sxab_session_establishment_response& m);
  void handle_itti_msg (core::itti::itti_sxab_session_modification_response& m);
  void handle_itti_msg (core::itti::itti_sxab_session_deletion_response& m);
  void handle_itti_msg (core::itti::itti_sxab_association_setup_request& m);
};
}
