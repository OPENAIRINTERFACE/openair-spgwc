...
inline void PrintValidatorPointers(
    unsigned depth, const char* s, const char* d) {
  printf("S: %*s%s\nD: %*s%s\n\n", depth * 4, " ", s, depth * 4, " ", d);
}
...
class IValidationErrorHandler {
 public:
  ...
  virtual void AboveMaximum(
      int64_t actual, const SValue& expected, bool exclusive) = 0;
  virtual void AboveMaximum(
      uint64_t actual, const SValue& expected, bool exclusive) = 0;
  virtual void AboveMaximum(
      double actual, const SValue& expected, bool exclusive) = 0;
  virtual void BelowMinimum(
      int64_t actual, const SValue& expected, bool exclusive) = 0;
  virtual void BelowMinimum(
      uint64_t actual, const SValue& expected, bool exclusive) = 0;
  virtual void BelowMinimum(
  ...
  virtual void TooManyProperties(
      SizeType actualCount, SizeType expectedCount) = 0;
  virtual void TooFewProperties(
      SizeType actualCount, SizeType expectedCount)   = 0;
  virtual void StartMissingProperties()               = 0;
  virtual void AddMissingProperty(const SValue& name) = 0;
  virtual bool EndMissingProperties()                 = 0;
  virtual void PropertyViolations(
    ...
    if (properties && properties->IsObject()) {
      ...
      for (ConstMemberIterator itr = properties->MemberBegin();
        ...
        if (FindPropertyIndex(itr->name, &index))
          schemaDocument->CreateSchema(
              &properties_[index].schema, q.Append(itr->name, allocator_),
              itr->value, document);
      }
    }
    ...
    if (const ValueType* v = GetMember(value, GetItemsString())) {
      ...
      if (v->IsObject())  // List validation
        ...
        for (ConstValueIterator itr = v->Begin(); itr != v->End();
             ++itr, index++)
          schemaDocument->CreateSchema(
              &itemsTuple_[itemsTupleCount_++], q.Append(index, allocator_),
              *itr, document);
      }
    }
...
#define RAPIDJSON_STRING_(name, ...)                                           \
  ...
  RAPIDJSON_STRING_(
      PatternProperties, 'p', 'a', 't', 't', 'e', 'r', 'n', 'P', 'r', 'o', 'p',
      'e', 'r', 't', 'i', 'e', 's')
  RAPIDJSON_STRING_(
      AdditionalProperties, 'a', 'd', 'd', 'i', 't', 'i', 'o', 'n', 'a', 'l',
      'P', 'r', 'o', 'p', 'e', 'r', 't', 'i', 'e', 's')
  RAPIDJSON_STRING_(
      MinProperties, 'm', 'i', 'n', 'P', 'r', 'o', 'p', 'e', 'r', 't', 'i', 'e',
      's')
  RAPIDJSON_STRING_(
      MaxProperties, 'm', 'a', 'x', 'P', 'r', 'o', 'p', 'e', 'r', 't', 'i', 'e',
      's')
  RAPIDJSON_STRING_(Items, 'i', 't', 'e', 'm', 's')
  RAPIDJSON_STRING_(MinItems, 'm', 'i', 'n', 'I', 't', 'e', 'm', 's')
  RAPIDJSON_STRING_(MaxItems, 'm', 'a', 'x', 'I', 't', 'e', 'm', 's')
  RAPIDJSON_STRING_(
      AdditionalItems, 'a', 'd', 'd', 'i', 't', 'i', 'o', 'n', 'a', 'l', 'I',
      't', 'e', 'm', 's')
  RAPIDJSON_STRING_(
  ...
  RAPIDJSON_STRING_(
      ExclusiveMinimum, 'e', 'x', 'c', 'l', 'u', 's', 'i', 'v', 'e', 'M', 'i',
      'n', 'i', 'm', 'u', 'm')
  RAPIDJSON_STRING_(
      ExclusiveMaximum, 'e', 'x', 'c', 'l', 'u', 's', 'i', 'v', 'e', 'M', 'a',
      'x', 'i', 'm', 'u', 'm')
  RAPIDJSON_STRING_(
...
class GenericSchemaDocument {
  ...
  */
  explicit GenericSchemaDocument(
    ...
    new (typeless_) SchemaType(
        this, PointerType(), ValueType(kObjectType).Move(),
 ...
 private:
  ...
  struct SchemaRefEntry {
    SchemaRefEntry(
        const PointerType& s, const PointerType& t,
  ...
  */
  ...
  void DoesNotMatch(const Ch* str, SizeType length) {
    ...
    currentError_.AddMember(
        GetActualString(), ValueType(str, length, GetStateAllocator()).Move(),
        GetStateAllocator());
  ...
  void TooFewItems(SizeType actualCount, SizeType expectedCount) {
    AddNumberError(
        SchemaType::GetMinItemsString(), ValueType(actualCount).Move(),
        SValue(expectedCount).Move());
  }
  void TooManyItems(SizeType actualCount, SizeType expectedCount) {
    AddNumberError(
        SchemaType::GetMaxItemsString(), ValueType(actualCount).Move(),
        SValue(expectedCount).Move());
  }
  void DuplicateItems(SizeType index1, SizeType index2) {
    ...
    currentError_.SetObject();
    currentError_.AddMember(
        GetDuplicatesString(), duplicates, GetStateAllocator());
  ...
  void EndMissingDependentProperties(const SValue& sourceName) {
    if (!missingDependents_.Empty())
      currentError_.AddMember(
          ValueType(sourceName, GetStateAllocator()).Move(), missingDependents_,
          GetStateAllocator());
  }
  void AddDependencySchemaError(
  ...
  void EndDisallowedType(const typename SchemaType::ValueType& actualType) {
    ...
    error.AddMember(
        GetActualString(), ValueType(actualType, GetStateAllocator()).Move(),
        GetStateAllocator());
    currentError_ = error;
 ...
 private:
...
#endif
  {
    if (basePath && basePathSize)
      memcpy(
          documentStack_.template Push<char>(basePathSize), basePath,
          basePathSize);
  }
  ...
  void AddErrorLocation(ValueType& result, bool parent) {
    ...
    ValueType instanceRef(
        sb.GetString(), static_cast<SizeType>(sb.GetSize() / sizeof(Ch)),
        GetStateAllocator());
  ...
  void AddCurrentError(
      const typename SchemaType::ValueType& keyword, bool parent = false) {
    AddErrorLocation(currentError_, parent);
    AddError(
        ValueType(keyword, GetStateAllocator(), false).Move(), currentError_);
  }
  ...
  void AddNumberError(
    ...
    currentError_.AddMember(
        GetExpectedString(), ValueType(expected, GetStateAllocator()).Move(),
        GetStateAllocator());
    if (exclusive)
      currentError_.AddMember(
...
class SchemaValidatingReader {
  ...
  */
  ...
  bool operator()(Handler& handler) {
    GenericReader<
        SourceEncoding, typename SchemaDocumentType::EncodingType,
        StackAllocator>
        reader;
