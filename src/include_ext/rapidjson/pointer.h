...
class GenericPointer {
  ...
  */
  ...
  /*!
     ...
     std::swap; swap(a.pointer, b.pointer);
      ...
      \see Swap()
   */
  friend inline void swap(GenericPointer& a, GenericPointer& b)
      RAPIDJSON_NOEXCEPT {
    a.Swap(b);
  }
  ...
  bool operator==(const GenericPointer& rhs) const {
    ...
    for (size_t i = 0; i < tokenCount_; i++) {
      if (tokens_[i].index != rhs.tokens_[i].index ||
          ...
          (tokens_[i].length != 0 &&
           std::memcmp(
               tokens_[i].name, rhs.tokens_[i].name,
  ...
  */
  ...
  ValueType& Create(
      GenericDocument<
          EncodingType, typename ValueType::AllocatorType, stackAllocator>&
          document,
      bool* alreadyExist = 0) const {
  ...
  */
  ...
  ValueType& Set(
      ValueType& root, const ValueType& value,
      typename ValueType::AllocatorType& allocator) const {
...
RAPIDJSON_DISABLEIF_RETURN(
    ...
    (typename T::ValueType&) )
GetValueByPointerWithDefault(
    T& root, const CharType (&source)[N], T2 defaultValue,
    typename T::AllocatorType& a) {
  return GenericPointer<typename T::ValueType>(source, N - 1)
      .GetWithDefault(root, defaultValue, a);
}
...
RAPIDJSON_DISABLEIF_RETURN(
    ...
    (typename T::ValueType&) )
SetValueByPointer(
    T& root, const CharType (&source)[N], T2 value,
    typename T::AllocatorType& a) {
  return GenericPointer<typename T::ValueType>(source, N - 1)
      .Set(root, value, a);
}
