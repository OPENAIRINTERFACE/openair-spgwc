...
struct UTF16 {
  ...
  static void EncodeUnsafe(OutputStream& os, unsigned codepoint) {
    ...
    if (codepoint <= 0xFFFF) {
      ...
      PutUnsafe(
          os, static_cast<typename OutputStream::Ch>((v & 0x3FF) | 0xDC00));
    }
  }
...
#define RAPIDJSON_ENCODINGS_FUNC(x)                                            \
  ...
  template<typename OutputStream>
  static RAPIDJSON_FORCEINLINE void Encode(
  ...
  template<typename OutputStream>
  static RAPIDJSON_FORCEINLINE void EncodeUnsafe(
      OutputStream& os, unsigned codepoint) {
    typedef void (*EncodeFunc)(OutputStream&, unsigned);
  ...
  template<typename InputStream>
  static RAPIDJSON_FORCEINLINE bool Decode(
  ...
  template<typename InputStream, typename OutputStream>
  static RAPIDJSON_FORCEINLINE bool Validate(
...
struct Transcoder {
  ...
  template<typename InputStream, typename OutputStream>
  static RAPIDJSON_FORCEINLINE bool Transcode(
      InputStream& is, OutputStream& os) {
    unsigned codepoint;
  ...
  template<typename InputStream, typename OutputStream>
  static RAPIDJSON_FORCEINLINE bool TranscodeUnsafe(
      InputStream& is, OutputStream& os) {
    unsigned codepoint;
    if (!SourceEncoding::Decode(is, &codepoint)) return false;
